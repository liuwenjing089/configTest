...
$(document).ready(function() {
	...
	//页面赋值
    $.ajax({
        url: "../mouldPreventionType/selectRepairMouldByConfirm.do",
        type: "POST",
        dataType: "json",
        data:{"id": id},
        async:false,
...
function allConfirm(){
	...
	if(preventionType == ""){
	    ...
	    $.ajax({
	  		url: '../mouldPreventionType/mouldRepairByMonitorConfirmAndAddType.do?id=' + id + '&mouldId='+ mouldId,
	  		type: 'GET',
	        async:false,
	  		beforeSend: function (XMLHttpRequest) {
	    ...
	    $.ajax({
	  		url: '../mouldPreventionType/mouldRepairByMonitorConfirm.do?id=' + id,
	  		type: 'GET',
	        async:false,
	  		beforeSend: function (XMLHttpRequest) {
