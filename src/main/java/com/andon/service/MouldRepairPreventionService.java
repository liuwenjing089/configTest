...
public interface MouldRepairPreventionService {
	 ...
	 * @param id
	 */
	public MouldRepair selectMouldRepairById(String uuid) throws Exception;
//	
//	/**
//	 * 更新模具报修表
//	 * 
...
//
	//各级别确认 + 插入模具报修种类
	public void mouldRepairByMonitorConfirmAndAddType(String id, String userName, int userType, int mouldId) throws Exception;
//	
//	/**
//	 * //获取部品分类
