...
public class SameRecurrenceRapir extends BaseEntity implements Serializable {
    ...
    private String userName;  //主作业者姓名中文
    private String applicantUserName;  //报修者姓名中文

    //是否填写完成ky
    private int isKy;
    
    private int mouldCssNum;
	...
	public int getMouldCssNum() {
		return mouldCssNum;
	}

	public void setMouldCssNum(int mouldCssNum) {
		this.mouldCssNum = mouldCssNum;
	}
