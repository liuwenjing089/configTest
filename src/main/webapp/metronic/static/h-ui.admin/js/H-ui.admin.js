...
function Hui_admin_tab(obj){
	...
	if(!bStop){
		creatIframe(href,title,iframId);
		min_titleList();
	}
	else{
...
function Hui_admin_tabs(href, title, iframId){
	var bStop = false,
		bStopIndex = 0,
		topWindow = $(window.parent.document),
		show_navLi = topWindow.find("#min_title_list li"),
...
function Hui_admin_tabs_From_storey(href, title, iframId){
	var bStop = false,
		bStopIndex = 0,
		topWindow = $(window.parent.parent.document),
		show_navLi = topWindow.find("#min_title_list li"),
		iframe_box = topWindow.find("#iframe_box");
	//console.log(topWindow);
	if(!href||href==""){
	...
	if(!bStop){
		creatIframe_From_storey(href,title, iframId);
		min_titleList();
	}
	else{
		show_navLi.removeClass("active").eq(bStopIndex).addClass("active");			
...
/*创建iframe*/
function creatIframe(href,titleName, iframId){
	var topWindow=$(window.parent.document),
		show_nav=topWindow.find('#min_title_list'),
		iframe_box=topWindow.find('#iframe_box'),
	...
	if(iframId != null && iframId !="" && iframId != undefined ){
		iframe_box.append('<div class="show_iframe"><div class="loading"></div><iframe frameborder="0" src='+href+' id='+ iframId +'></iframe></div>');
	}else{
...
/*创建iframe*/
function creatIframe_From_storey(href,titleName, iframId){
